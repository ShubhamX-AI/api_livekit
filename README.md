...
A production-ready service for deploying real-time AI voice agents using LiveKit, OpenAI Realtime API, and Cartesia TTS. This service provides a REST API for managing assistants, SIP trunks, and triggering outbound calls, along with a robust agent worker for handling real-time interactions.

## 🚀 Features

- **Real-time AI Agents**: Powered by OpenAI Realtime API (GPT-4o) and Cartesia TTS.
- **SIP Support**: Create and manage SIP outbound trunks (Twilio/Exotel) for telephony integration.
- **Outbound Calls**: Trigger programmatic outbound calls to phone numbers.
- **Dynamic Assistants**: Create and configure assistants with custom prompts, voices, and start instructions.
...
```json
{
  ...
  "data": {
    ...
    "assistant_name": "Support Agent",
    "to_number": "+15550000000",
    "recording_path": "recordings/room_name.ogg",
    "transcripts": [
      {
        "speaker": "agent",
...
4. Initializes OpenAI Realtime API and Cartesia TTS.
