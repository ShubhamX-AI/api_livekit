...
MEETING_CONNECTOR_EVENTS_TOPIC = "meeting_connector_events"
MEETING_CONNECTOR_STATUS_ATTRIBUTE = "lk.meeting_connector_status"
MEETING_CONNECTOR_EVENT_WAITING = "waiting"
MEETING_CONNECTOR_EVENT_READY = "ready"
MEETING_CONNECTOR_EVENT_FAILED = "failed"
MEETING_CONNECTOR_EVENT_ENDED = "ended"
MEETING_CONNECTOR_EVENTS = frozenset(
    {
        MEETING_CONNECTOR_EVENT_WAITING,
